...
exports.MountTerminalProviderImpl = void 0;
/**
 ...
 */
class MountTerminalProviderImpl {
    /**
     ...
     */
    constructor(terminalProvider, mountManager, sessionManager) {
        this._disposables = [];
     ...
     */
    async resolveWorkingDirectory(mountId, relativePath) {
        // Get the mount point
        const mountPoint = this._mountManager.getMountById(mountId);
        if (!mountPoint) {
            throw new Error(`Mount point with ID ${mountId} not found`);
     ...
     */
    _addTerminalToMount(mountId, terminal) {
...
exports.MountTerminalProviderImpl = MountTerminalProviderImpl;
/**
 * Pseudo-terminal implementation for mounted folders
 */
class MountPseudoTerminal {
    /**
     * Creates a new mount pseudo-terminal
     * @param remoteTerminal The underlying remote terminal
     * @param mountPoint The mount point
     */
    constructor(_remoteTerminal, _mountPoint) {
        this._remoteTerminal = _remoteTerminal;
        ...
        this._remoteTerminal.onData((data) => {
            this._writeEmitter.fire(data);
        });
        this._remoteTerminal.onExit((code) => {
...
//# sourceMappingURL=mount-terminal-provider.js.map