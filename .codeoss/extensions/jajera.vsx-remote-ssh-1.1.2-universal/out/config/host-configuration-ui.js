...
class HostConfigurationUI {
     ...
     */
    async showHostSelectionMenu() {
        const hosts = await this.configManager.getHosts();
        if (hosts.length === 0) {
            const addHost = await vscode.window.showQuickPick(['Yes', 'No'], {
...
exports.HostConfigurationUI = HostConfigurationUI;
//# sourceMappingURL=host-configuration-ui.js.map