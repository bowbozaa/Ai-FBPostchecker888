...
exports.LanguageServerManagerImpl = void 0;
/**
 * Implementation of the LanguageServerManager interface
 */
class LanguageServerManagerImpl {
    constructor(connectionManager) {
        this.connectionManager = connectionManager;
        this.activeServers = new Map();
        this.serverInstallCommands = new Map();
     ...
     */
    async getActiveLanguageServers(connectionId) {
     ...
     */
    async isLanguageServerAvailable(connectionId, languageId) {
        const connection = this.getConnection(connectionId);
        try {
     ...
     */
    async installLanguageServer(connectionId, languageId) {
        const connection = this.getConnection(connectionId);
        try {
     ...
     */
    getLanguageServerCheckCommand(languageId) {
        switch (languageId) {
            case 'typescript':
            case 'javascript':
     ...
     */
    getLanguageServerStartCommand(languageId) {
        switch (languageId) {
            case 'typescript':
            case 'javascript':
     ...
     */
    getLanguageServerProcessName(languageId) {
        switch (languageId) {
            case 'typescript':
            case 'javascript':
     ...
     */
    addActiveServer(connectionId, languageId) {
     ...
     */
    removeActiveServer(connectionId, languageId) {
        const servers = this.activeServers.get(connectionId);
        if (servers) {
...
exports.LanguageServerManagerImpl = LanguageServerManagerImpl;
//# sourceMappingURL=language-server-manager.js.map